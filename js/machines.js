...
const MACHINES = [
    ...
    },
    {
        id: "lunar_fab",
        name: "Lunar Fab",
        desc: "Usine automatisée sur la Lune, exploitant le vide spatial parfait.",
        icon: "🌖",
        unlockYear: 2055,
        baseCost: 50_000_000_000_000,
        rdCost: 20_000_000_000_000,
        baseProduction: 10_000_000_000_000_000_000_000,
        tier: 14,
        realInfo: "2055 (Fictif) — L'absence d'atmosphère et la faible gravité lunaire permettent des procédés de lithographie extrêmes impossibles sur Terre.",
        rdInfo: "R&D : $20T — Déploiement d'une infrastructure autonome sur la Lune et extraction in situ d'hélium-3 et de silicium lunaire."
    },
    {
        id: "mars_fab",
        name: "Fonderie Martienne",
        desc: "Complexe industriel couvrant des cratères martiens entiers.",
        icon: "🔴",
        unlockYear: 2065,
        ...
        tier: 14,
        realInfo: "2065 (Fictif) — Mars devient la capitale industrielle du système solaire intérieur, dédiée presque entièrement à la computation.",
        rdInfo: "R&D : $100T — Terraformation partielle pour refroidir d'immenses datacenters et usines de transistors."
    },
    {
        id: "kuiper_mining",
        name: "Exploitation Kuiper",
        desc: "Minage et production automatisés dans la ceinture de Kuiper.",
        icon: "☄️",
        unlockYear: 2080,
        ...
        tier: 15,
        realInfo: "2080 (Fictif) — Des millions d'astéroïdes sont convertis en usines autonomes, formant un anneau de production autour du Soleil.",
        rdInfo: "R&D : $5Q — Technologies de propulsion avancée et d'essaims robotiques capables de dévorer et convertir des corps célestes glacés."
    },
    {
        id: "jupiter_brain",
        name: "Cerveau de Jupiter",
        desc: "Jupiter transformée en un méga-ordinateur géant.",
        icon: "🪐",
        unlockYear: 2100,
        ...
        tier: 15,
        realInfo: "2100 (Fictif) — La masse de la plus grande planète du système solaire est réassemblée en une structure computationnelle d'une échelle inimaginable.",
        rdInfo: "R&D : $500Q — Maîtrise de la gravité à l'échelle planétaire pour stabiliser une mégastructure de la taille de Jupiter."
    },
    {
        id: "dyson_swarm",
        name: "Essaim de Dyson",
        desc: "Captation de toute l'énergie du Soleil pour alimenter la production.",
        icon: "☀️",
        unlockYear: 2150,
        ...
        tier: 16,
        realInfo: "2150 (Fictif) — L'humanité est devenue une civilisation de Type II sur l'échelle de Kardashev, utilisant toute l'énergie d'une étoile.",
        rdInfo: "R&D : $50s — Démantèlement de planètes entières pour construire des milliards de collecteurs solaires et d'usines en orbite."
    },
    {
        id: "galactic_forge",
        name: "Forge Galactique",
        desc: "Réseau d'usines s'étendant à travers la Voie Lactée.",
        icon: "🌌",
        unlockYear: 2300,
        ...
        tier: 17,
        realInfo: "2300 (Fictif) — Civilisation de Type III. Les trous noirs supermassifs sont utilisés comme source d'énergie pour la production de transistors.",
        rdInfo: "R&D : $5S — Voyage supraluminique et terraformation stellaire pour synchroniser une chaîne de production galactique."
    },
    {
        id: "universal_fabricator",
        name: "Fabricateur Universel",
        desc: "L'univers entier calculant en harmonie.",
        icon: "✨",
        unlockYear: 3000,
        ...
        tier: 18,
        realInfo: "3000 (Fictif) — Le tissu même de l'espace-temps est reprogrammé pour agir comme un gigantesque transistor quantique.",
        rdInfo: "R&D : $500S — Compréhension totale et manipulation de la matière noire et de l'énergie noire."
    }
];
